...
wget --mirror --continue --no-host-directories ftp://anon-ftp.ceda.ac.uk/neodc/esacci/sea_surface_salinity/data/v02.31/30days/$year --directory-prefix=../data/sea_surface_salinity/$year
