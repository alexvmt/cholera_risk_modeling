...
# this script downloads and preprocesses daily day land surface temperature data
# from the ESA Climate Change Initiative for a given month of a given year
